...
public class WebTabelHandelConcept {
	...
	public static void main(String[] args) throws InterruptedException {
		...
		//selectMultipleContact("Ali khan");
		String contactName=getContactCompanyName("Ramya pingili");
	...
	public static void selectMultipleContact(String contactName) {
		List<WebElement> contactChecks = driver.findElements(By
